...
Item {
    ...
    Rectangle {
        ...
        ApproveButton {
            ...
            onClicked: {
                backend.updatePassenger(customSearchableComboBox.typedText)
        ...
        RejectButton {
            ...
            onClicked: {
                content.replace(Qt.resolvedUrl("PassengerInfoZoneView.qml"))
            }
        }
        ...
        CustomSearchableComboBox {
            ...
            model: backend.getPassengers()
            placeholderText: backend.getPassengerID()
